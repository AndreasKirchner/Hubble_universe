...
thermodynamic(T::N,x::IdealQCD) where {N} = Thermodynamic{N,1,1}(pressure(T,x),(pressure_derivative(T,Val{1}(),x),),(pressure_derivative(T,Val{2}(),x),) ) 
