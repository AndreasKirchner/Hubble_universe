...
struct NeuralNet6M{T,R,S} <:EquationOfState
    ...
    function NeuralNet6M()
        #load the models
        @load "6Net_1RBT.bson" model1
        @load "6Net_2RBT.bson" model2
        @load "6Net_3RBT.bson" model3
        @load "6Net_4RBT.bson" model4
        @load "6Net_5RBT.bson" model5
        @load "6Net_6RBT.bson" model6
        @load "hpnormsB.bson" normList#"6norms.bson" normList
